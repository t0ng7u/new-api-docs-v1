...
<Callout type="warn" title="ファイルアップロード制限">
  音声のアップロードは `inline_data` を介した base64 方式のみをサポートしており、`file_data.file_uri`
  や File API はサポートしていません。
</Callout>
...
<Callout type="warn" title="ファイルアップロード制限">
  動画のアップロードは `inline_data` を介した base64 方式のみをサポートしており、`file_data.file_uri`
  や File API はサポートしていません。
</Callout>
...
<Callout type="warn" title="ファイルアップロード制限">
  PDF のアップロードは `inline_data` を介した base64 方式のみをサポートしており、`file_data.file_uri`
  や File API はサポートしていません。
</Callout>
